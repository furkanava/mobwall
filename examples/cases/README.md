...
These are original fictional briefs, not customer case studies or measured growth results. They exercise different product contexts without borrowing another app's branding.

| Case | Starting point | Design question |
| --- | --- | --- |
| [Grove](grove.md) | Existing meditation-library offer | How can the screen communicate useful outcomes and the actual annual charge? |
