...
[cases.json](cases.json) contains eleven realistic scenarios and observable criteria. These are evaluation inputs, not a claim that eleven model runs passed. The [Grove worked example](../examples/cases/grove-result.md) is an authored reference, not an independent evaluation.
