...
- **Existing app + implementation request:** read [implementation.md](references/implementation.md) and the applicable [Android](references/android.md) or [Flutter](references/flutter.md) reference, edit the relevant screen, preserve real product data and purchase handlers, and verify the affected flow with available build/test/preview tools.
